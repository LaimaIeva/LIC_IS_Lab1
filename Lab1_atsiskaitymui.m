...
%A1,A2,A3,P1,P2
%building matrix 2x5
x1=[hsv_value_A6 hsv_value_A7 hsv_value_P2 hsv_value_P3 hsv_value_P4];
x2=[metric_A6 metric_A7 metric_P2 metric_P3 metric_P4];
% estimated features are stored in matrix P:
P=[x1;x2];

%Desired output vector
d=[1;1;-1;-1;-1]; % <- ČIA ANKSČIAU BUVO KLAIDA!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
